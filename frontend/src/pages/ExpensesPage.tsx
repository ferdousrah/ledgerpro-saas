...
import { Add, Edit, Delete, TrendingDown, Warning as WarningIcon } from '@mui/icons-material';
  ...
  const loadData = async () => {
    try {
      const [transactionsData, accountsData, categoriesData] = await Promise.all([
        transactionsApi.list({ transaction_type: TransactionType.EXPENSE }),
        accountsApi.list(),
        categoriesApi.list(TransactionType.EXPENSE),
      ]);
  ...
  return (
    <DashboardLayout>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Total Expenses: <strong style={{ color: '#f44336' }}>{formatCurrency(totalExpense, tenant?.currency || 'USD')}</strong>
          </Typography>
        </Box>
        <Button
          variant="contained"
        ...
        <CardContent>
          {transactions.length === 0 ? (
            <Box py={8} textAlign="center">
              ...
              <Typography variant="body2" color="text.secondary">
                Click "Add Expense" to record your first expense transaction
              </Typography>
            </Box>
          ) : (
              ...
              <DataGrid
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    width: 150,
                    renderCell: (params) => (
                      <Chip label={getCategoryName(params.value)} size="small" color="error" variant="outlined" />
                    ),
                  },
                  {
                    field: 'description',
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
        <DialogHeader title={editingTransaction ? 'Edit Expense' : 'Add Expense'} onClose={handleCloseDialog} />
        <DialogContent>
